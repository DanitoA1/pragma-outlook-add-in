<template>
  <div class="h-full">
    <div v-if="!isSnippets()" class="flex flex-col justify-center" style="height: 100vh">
      ...
      <p class="self-center mt-6 text-12px text-secondary">Start now and create snippetse</p>
      <div class="self-center flex mt-8">
        <button @click="gotoDashboard" class="bg-primary ml-10 text-white w-162px rounded-md py-2">
          Create Snippet
        </button>
